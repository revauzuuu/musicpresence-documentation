...
!!! warning "TODOs for this page"
    - Auto-generate this from the changelog in the repository: [CHANGELOG.md](https://github.com/ungive/discord-music-presence/blob/master/CHANGELOG.md)
    - Automatically add a warning, if the latest changelog version is newer than the latest tag, to indicate whether the changelog entry is already released. Perhaps allow custom text for specific upcoming releases
    - Python Markdown requires 4 spaces of indentation. Either change the indentation to 4 spaces and stick with it or automatically convert 2-space indentation to 4-space indentation, since it's broken right now
    - Remove the headings under 2.2.0 (already did that manually for this page)
...
More information under "Scrobbling" in the settings window of the app.
