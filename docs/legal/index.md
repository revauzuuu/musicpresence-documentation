...
- [**Scrobbling License Terms**](./scrobbling-license-terms.md): This document outlines the terms and conditions for use of scrobbling features within the Music Presence desktop application. You are bound by these terms when you start a scrobbling free trial, when you purchase a scrobbling license or when you claim a scrobbling license with a gift code.
...
Should there be discrepancies between this page and one of our terms or policies, then the respective terms or policies take precedence over the information presented on this page. If you find an error, do not hesitate to contact us immediately via one of the contact methods described in our policies.
